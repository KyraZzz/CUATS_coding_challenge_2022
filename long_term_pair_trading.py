...
class AlgoTradingCourse10(QCAlgorithm):
    """ Simple long-term strategy: SPY (equity) and BND (bond) usually have a negative correlation
        Uptrend then do 80% SPY and 20% BND, downtrend then do 20% SPY and 80% BND
        Rebalance to 80% SPY and 20% BND if no trand change for 30 days
    """
    def Initialize(self):
